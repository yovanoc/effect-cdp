...
const emitStruct = (domain: string, name: string, suffix: "params" | "result", properties: ReadonlyArray<Property> | undefined, cyclicDomains?: ReadonlySet<string>): string => {
...
const emitResult = (domain: string, cmd: CommandDef, cyclicDomains?: ReadonlySet<string>): string => {
...
export function emitCommand(domain: string, cmd: CommandDef, cyclicDomains?: ReadonlySet<string>): string {
