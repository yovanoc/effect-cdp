...
export const StringIndex = Schema.Number.annotate({ identifier: "DOMSnapshot.StringIndex" });

export const ArrayOfStrings = Schema.Array(StringIndex).annotate({ identifier: "DOMSnapshot.ArrayOfStrings" });
...
export const Rectangle = Schema.Array(Schema.Number).annotate({ identifier: "DOMSnapshot.Rectangle" });
...
export const disable = {
  ...
  params: Schema.Struct({}).annotate({ identifier: "DOMSnapshot.disable.params" }),
  result: Schema.Struct({}).annotate({ identifier: "DOMSnapshot.disable.result" }),
} as const

export const enable = {
  method: "DOMSnapshot.enable" as const,
  params: Schema.Struct({}).annotate({ identifier: "DOMSnapshot.enable.params" }),
  result: Schema.Struct({}).annotate({ identifier: "DOMSnapshot.enable.result" }),
} as const
