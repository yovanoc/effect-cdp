...
export const GestureSourceType = Schema.Literals(["default", "touch", "mouse"]).annotate({ identifier: "Input.GestureSourceType" });

export const MouseButton = Schema.Literals(["none", "left", "middle", "right", "back", "forward"]).annotate({ identifier: "Input.MouseButton" });

export const TimeSinceEpoch = Schema.Number.annotate({ identifier: "Input.TimeSinceEpoch" });
...
export const cancelDragging = {
  ...
  params: Schema.Struct({}).annotate({ identifier: "Input.cancelDragging.params" }),
  result: Schema.Struct({}).annotate({ identifier: "Input.cancelDragging.result" }),
} as const
...
export const dispatchDragEvent = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.dispatchDragEvent.result" }),
} as const
...
export const dispatchKeyEvent = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.dispatchKeyEvent.result" }),
} as const

export const dispatchMouseEvent = {
  method: "Input.dispatchMouseEvent" as const,
  params: Schema.Struct({
    "type": Schema.Literals(["mousePressed", "mouseReleased", "mouseMoved", "mouseWheel"]),
    "x": Schema.Number,
    "y": Schema.Number,
    "modifiers": Schema.optional(Schema.Number),
    "timestamp": Schema.optional(TimeSinceEpoch),
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.dispatchMouseEvent.result" }),
} as const

export const dispatchTouchEvent = {
  method: "Input.dispatchTouchEvent" as const,
  params: Schema.Struct({
    "type": Schema.Literals(["touchStart", "touchEnd", "touchMove", "touchCancel"]),
    "touchPoints": Schema.Array(TouchPoint),
    "modifiers": Schema.optional(Schema.Number),
    "timestamp": Schema.optional(TimeSinceEpoch)
  }).annotate({ identifier: "Input.dispatchTouchEvent.params" }),
  result: Schema.Struct({}).annotate({ identifier: "Input.dispatchTouchEvent.result" }),
} as const
...
export const emulateTouchFromMouseEvent = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.emulateTouchFromMouseEvent.result" }),
} as const
...
export const imeSetComposition = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.imeSetComposition.result" }),
} as const
...
export const setIgnoreInputEvents = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.setIgnoreInputEvents.result" }),
} as const
...
export const setInterceptDrags = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.setInterceptDrags.result" }),
} as const
...
export const synthesizePinchGesture = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.synthesizePinchGesture.result" }),
} as const
...
export const synthesizeScrollGesture = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.synthesizeScrollGesture.result" }),
} as const
...
export const synthesizeTapGesture = {
  ...
  result: Schema.Struct({}).annotate({ identifier: "Input.synthesizeTapGesture.result" }),
} as const
